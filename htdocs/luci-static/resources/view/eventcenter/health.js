...
(function(){var bg=getComputedStyle(document.body).backgroundColor,m=bg.match(/\d+/g);if(m){var lum=(0.299*+m[0]+0.587*+m[1]+0.114*+m[2])/255;if(lum<0.5)document.documentElement.classList.add('ec-dark')}var s=document.createElement('style');s.textContent='.ec-dark .ec-card,.ec-dark .cbi-section{background:#1e1e2e!important;box-shadow:0 2px 8px rgba(0,0,0,.3)!important}.ec-dark .ec-table th{border-bottom-color:#333!important;color:#9ca3af!important}.ec-dark .ec-table td{border-bottom-color:#2a2a3e!important}.ec-dark .ec-on{background:#064e3b;color:#6ee7b7}.ec-dark .ec-off{background:#7f1d1d;color:#fca5a5}.ec-dark .cbi-page-actions{border-top-color:#374151!important}.ec-dark [style*="background:var(--background-color-white"]{background:#1e1e2e!important}.ec-dark [style*="background:var(--background-color,"]{background:#1e1e2e!important}.ec-dark [style*="background:var(--background-color-secondary"]{background:#1f2937!important}.ec-dark [style*="color:var(--text-color-secondary"]{color:#9ca3af!important}.ec-dark [style*="color:var(--text-color,"]{color:#d1d5db!important}.ec-dark [style*="border-bottom:1px solid var(--border-color-light"]{border-color:#374151!important}.ec-dark [style*="border-top:1px solid var(--border-color-light"]{border-color:#374151!important}.ec-dark [style*="border-bottom:2px solid var(--border-color-light"]{border-color:#374151!important}';document.head.appendChild(s)})();
