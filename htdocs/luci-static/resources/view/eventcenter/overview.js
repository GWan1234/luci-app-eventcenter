...
return view.extend({
	...
	render: function(data) {
		...
		(function(){var bg=getComputedStyle(document.body).backgroundColor,m=bg.match(/\d+/g);if(m){var lum=(0.299*+m[0]+0.587*+m[1]+0.114*+m[2])/255;if(lum<0.5)document.documentElement.classList.add('ec-dark')}var s=document.createElement('style');s.textContent='.ec-dark .ec-card{background:#1e1e2e!important;box-shadow:0 2px 8px rgba(0,0,0,.3)!important}.ec-dark .ec-dev{border-bottom-color:#333!important}.ec-dark .ec-on{background:#064e3b;color:#6ee7b7}.ec-dark .ec-off{background:#7f1d1d;color:#fca5a5}.ec-dark .ec-bar{background:#374151!important}.ec-dark .ec-fill{box-shadow:inset 0 1px 0 rgba(255,255,255,.08)}.ec-dark .ec-lbl{color:#9ca3af!important}.ec-dark .ec-actions{border-top-color:#374151!important}.ec-dark [style*=\"background:var(--background-color-secondary\"]{background:#1f2937!important}.ec-dark [style*=\"color:var(--text-color-secondary\"]{color:#9ca3af!important}.ec-dark [style*=\"border-bottom:1px solid var(--border-color-light\"]{border-color:#374151!important}';document.head.appendChild(s)})();
